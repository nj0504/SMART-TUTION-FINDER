...
public class Main extends JFrame implements ActionListener{
    ...
    JLabel title, footerLbl, mainScreenLbl, title_1;
    JMenuBar menuBar;
    JMenu file, about;
    JMenuItem aboutProject, exit;
    public static Main main;
    public Main(){
        super("Smart Tution Finder");
        setSize(1280,720);
        setLocation(35,30);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/img_2.png"));
        Image i2 = i1.getImage().getScaledInstance(1280 ,150 ,Image.SCALE_DEFAULT);
        ...
        //Main Center Code
        ImageIcon loginImg1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/login.png"));
        ...
        ImageIcon signUpImg1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/signup.png"));
        ...
        ImageIcon mainPic1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/img.png"));
        Image mainPic2 = mainPic1.getImage().getScaledInstance(200 ,100 ,Image.SCALE_DEFAULT);
        ...
        // Footer Panel Code
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("project/icons/footer.png"));

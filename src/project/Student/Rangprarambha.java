...
public class Rangprarambha extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel jLabel5 = new JLabel("Rangaprarambha");
        JLabel jLabel6 = new JLabel("Classes");
        ...
        jLabel1.setText("Tutor name: Minakshi Kulkarni");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 15));
        jLabel2.setText("Phone no.: 7580449578");
        ...
        jLabel4.setText("Courses providing: Sketching, Canvas drawing and painting");
        ...
        jPanel1.add(jLabel6, BorderLayout.NORTH);
        jLabel6.setPreferredSize(new Dimension(200, 50));
